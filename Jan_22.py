...
# =======================================Fault===================================================================
    if page =='Faults':
        ...
        df2 = fetch_file('Fault 2022-02-18 230843.xlsx')
        ...
        df3 = df3.loc[:, ['Site', 'Building', 'Floor', 'Room', 'Building_Trade', 'Trade_Category', 'Type_of_Fault', 'Time_Acknowledged_mins',
                   'Time_Site_Reached_mins', 'Time_Work_Started_mins', 'Time_Work_Recovered_mins', 'Remarks']]

        bin_responded = [0, 10, 30, 120, np.inf]
        label_responded = ['0-10mins', '10-30mins', '30-120mins', '120-np.inf']

        bin_recovered = [0, 60, np.inf]
        label_recovered = ['0-1hr', '1-np.inf']
        ...
        df_daily = df2.loc[(df2['Cancel_Status'].isna()) & (df2['Work_Completed_Date'].notna()),:] #some columns is not exist in df3, cos we drop some columns above
...
#--------------------------------------- color & width & opacity----------------------------------------------
    ...
    #--------------------------------------Daily Fault----------------------------------------------------------
     ...
     #---------------------------------------------KPI Monitoring-------------------------------------------------------
        ...
        x_KPI_building_3060_Responded = df3.groupby(by='KPI_For_Responded').Building_Trade.value_counts().loc['30-120mins'].index
        x_KPI_building_60inf_Responded = df3.groupby(by='KPI_For_Responded').Building_Trade.value_counts().loc['120-np.inf'].index

        y_KPI_building_010_Responded = df3.groupby(by='KPI_For_Responded', observed=True).Building_Trade.value_counts().loc['0-10mins'].values
        y_KPI_building_1030_Responded = df3.groupby(by='KPI_For_Responded', observed=True).Building_Trade.value_counts().loc['10-30mins'].values
        y_KPI_building_3060_Responded = df3.groupby(by='KPI_For_Responded', observed=True).Building_Trade.value_counts().loc['30-120mins'].values
        y_KPI_building_60inf_Responded = df3.groupby(by='KPI_For_Responded', observed=True).Building_Trade.value_counts().loc['120-np.inf'].values

        x_KPI_category_010_Responded = df3.groupby(by='KPI_For_Responded', observed=True).Trade_Category.value_counts().loc['0-10mins'].index
        x_KPI_category_1030_Responded = df3.groupby(by='KPI_For_Responded', observed=True).Trade_Category.value_counts().loc['10-30mins'].index
        x_KPI_category_3060_Responded = df3.groupby(by='KPI_For_Responded', observed=True).Trade_Category.value_counts().loc['30-120mins'].index
        x_KPI_category_60inf_Responded = df3.groupby(by='KPI_For_Responded', observed=True).Trade_Category.value_counts().loc['120-np.inf'].index

        y_KPI_category_010_Responded = df3.groupby(by='KPI_For_Responded', observed=True).Trade_Category.value_counts().loc['0-10mins'].values
        y_KPI_category_1030_Responded = df3.groupby(by='KPI_For_Responded', observed=True).Trade_Category.value_counts().loc['10-30mins'].values
        y_KPI_category_3060_Responded = df3.groupby(by='KPI_For_Responded', observed=True).Trade_Category.value_counts().loc['30-120mins'].values
        y_KPI_category_60inf_Responded = df3.groupby(by='KPI_For_Responded', observed=True).Trade_Category.value_counts().loc['120-np.inf'].values
        ...
        with fig_responded_building, _lock:
            fig_responded_building = go.Figure(data=[
                ...
                go.Bar(name='30-120mins', x=x_KPI_building_3060_Responded, y=y_KPI_building_3060_Responded, marker_color=colorstackbarfail02),
                go.Bar(name='120-np.inf', x=x_KPI_building_60inf_Responded, y=y_KPI_building_60inf_Responded, marker_color=colorstackbarfail03)
            ])
        ...
        with fig_responded_category, _lock:
            fig_responded_category = go.Figure(data=[
                ...
                go.Bar(name='30-120mins', x=x_KPI_category_3060_Responded, y=y_KPI_category_3060_Responded, marker_color=colorstackbarfail02),
                go.Bar(name='120-np.inf', x=x_KPI_category_60inf_Responded, y=y_KPI_category_60inf_Responded, marker_color=colorstackbarfail03),
            ])
        ...
        x_KPI_building_60inf_recovered = df3.groupby(by='KPI_For_Recovered').Building_Trade.value_counts().loc['1-np.inf'].index
        ...
        y_KPI_building_60inf_recovered = df3.groupby(by='KPI_For_Recovered').Building_Trade.value_counts().loc['1-np.inf'].values
        ...
        x_KPI_category_60inf_recovered = df3.groupby(by='KPI_For_Recovered').Trade_Category.value_counts().loc['1-np.inf'].index
        ...
        y_KPI_category_60inf_recovered = df3.groupby(by='KPI_For_Recovered').Trade_Category.value_counts().loc['1-np.inf'].values
        ...
        with fig_recovered_building, _lock:
            fig_recovered_building = go.Figure(data=[
                ...
                go.Bar(name='1-np.inf', x=x_KPI_building_60inf_recovered, y=y_KPI_building_60inf_recovered, marker_color=colorstackbarfail03)
            ])
        ...
        with fig_recovered_category, _lock:
            fig_recovered_category = go.Figure(data=[
                ...
                go.Bar(name='1-np.inf', x=x_KPI_category_60inf_recovered, y=y_KPI_category_60inf_recovered, marker_color=colorstackbarfail03)
            ])
 ...
 #---------------------------Fault vs Building Trade & Trade Category & Type of Fault----------------------------------
        ...
        df4= df4[['Site', 'Building', 'Floor', 'Room', 'Building_Trade', 'Trade_Category', 'Type_of_Fault', 'Time_Acknowledged_hrs',
    ...
    ## groupby building level
        df4['buildinglevel'] = df4.Building + '-' + df4.Floor.astype(str)
    ...
    ## groupby building level room
        df4['buildinglevelroom'] = df4.Building + '-' + df4.Floor.astype(str) + '-' + df4.Room
...
# =======================================================================================Inventories=========================================================================================
    if page =='Inventories':
        ...
        html_card_subheader_inventoriesCO = """
            <div class="card">
              <div class="card-body" style="border-radius: 10px 10px 0px 0px; background:#ff4f00; padding-top: 5px; width: 700px;
               height: 50px;">
                <h3 class="card-title" style="background-color:#ff4f00; color:#eabd1d; font-family:Georgia; text-align: center; padding: 0px 0;">Inventory Movement Morning-Connection One</h3>
              </div>
            </div>
            """
        ...
        st.markdown('##')
        st.markdown('##')
        st.markdown(html_card_subheader_inventoriesCO, unsafe_allow_html=True)
        st.markdown('##')
        ...
        df_CO_t = pd.read_excel('Transaction 2022-02-19 010503.xlsx', header=1, usecols=trans_cols, parse_dates=date)
        df_CO_t['Created day'] = df_CO_t['Created date'].dt.day
        df_CO_t['Reference number'] = df_CO_t['Reference number'].astype(str)
        df_CO_t['Ref. ID'] = df_CO_t['Ref. ID'].astype(str)

        df_CO_t_draw = df_CO_t[df_CO_t['Type']=='Withdraw']
        ser_CO_daily_draw = df_CO_t_draw.groupby(by=['Created day'])['Request to draw or add'].sum()
        ser_CO_fast_draw = df_CO_t_draw.groupby(by=['Description'])['Request to draw or add'].sum().sort_values(ascending=False).head(10)

        inventorylist = ser_CO_fast_draw.sort_values(ascending=True).index
        df_CO_fast_drawinfo = df_CO_t_draw.loc[(df_CO_t_draw['Description'].isin(inventorylist)), ['Description', 'Request to draw or add', 
        ...
        df_CO_balance = pd.read_excel('Inventories 2022-02-19 010600.xlsx', header=1, usecols=balance_cols)

        total_inventory_balanceCO = df_CO_balance['Quantity'].sum()
        total_inventory_drawedCO = df_CO_t[df_CO_t.Type=='Withdraw']['Request to draw or add'].sum()
        total_replenishmentCO = df_CO_t[df_CO_t.Type=='Add Quantity']['Request to draw or add'].sum()
        total_transaction = df_CO_t['Description'].count()
        ...
        with column01_inventory, _lock:
            st.markdown('**Balance**')
            st.markdown(f"<h2 style='text-align: left; color: #703bef;'>{total_inventory_balanceCO}</h2>", unsafe_allow_html=True)
        with column02_inventory, _lock:
            st.markdown('**Requested**')
            st.markdown(f"<h2 style='text-align: left; color: #3c9992;'>{total_inventory_drawedCO}</h2>", unsafe_allow_html=True)
        with column03_inventory, _lock:
            st.markdown('**Replenishment**')
            st.markdown(f"<h2 style='text-align: left; color: #d0c101;'>{total_replenishmentCO}</h2>", unsafe_allow_html=True)
        ...
        xinventories_fast = ser_CO_fast_draw.sort_values(ascending=True).index
        yinventories_fast = ser_CO_fast_draw.sort_values(ascending=True).values
        ...
        st.dataframe(df_CO_fast_drawinfo, height=350)
